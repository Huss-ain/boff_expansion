...
export const Hero = () => {
  ...
  return (
    <section ref={heroRef} className='pt-8 pb-2 md:pt-5 md:pb-10 bg-[radial-gradient(ellipse_200%_100%_at_bottom_left,_#B5F1CC,_#FFE0FF_80%)] overflow-x-clip'>
      <div className="w-full flex justify-center">
        <div className='text-center w-full max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8 pt-12 pb-12 md:pt-20 md:pb-20'>
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-7xl font-bold tracking-tighter text-shine mt-6 leading-tight w-full">
            Engage prospects and grow your business with empathetic outreach at scale.
          </h1>
