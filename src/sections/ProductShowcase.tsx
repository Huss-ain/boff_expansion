  ...
  <section id="product" className="bg-gradient-to-b from-[#f9f7ff] to-[#eef5ff] py-24 overflow-x-clip">
    <div className="container mx-auto px-4">
      <div className="mx-w-[740px] mx-auto">
        <h2 className="text-center text-3xl md:text-[54px] md:leading-[60px] font-bold tracking-tighter bg-gradient-to-r from-[#3c2a06] to-[#422301] text-transparent bg-clip-text mt-7">A specialist human touch to outreach</h2>
