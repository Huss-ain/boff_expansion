        ...
        <div className="hidden md:inline-flex gap-2 items-center">
          ...
          <div className='py-5 px-10 bg-white/90 border-b border-purple-100 shadow-sm'>
            <div className="container">
              ...
              <nav className="hidden md:flex gap-6 items-center">
                ...
                <button 
                  className='bg-black/50 text-white px-4 py-2 rounded-lg font-medium text-base md:text-lg tracking-tight inline-flex items-center justify-center cursor-not-allowed'
                  disabled
                >
                  Book a call
                </button>
          ...
          <div className={`md:hidden bg-white/95 shadow-lg ${mobileMenuOpen ? 'block' : 'hidden'}`}>
            <nav className="flex flex-col items-center gap-4 py-6">
              ...
              <button 
                className='bg-black/50 text-white px-6 py-3 rounded-lg font-medium text-lg tracking-tight inline-flex items-center justify-center cursor-not-allowed mt-2'
                disabled
              >
                Book a call
              </button>
